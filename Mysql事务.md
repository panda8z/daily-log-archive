...
一个事务由批量的 **DML**(`insert`、`update`、`delete`)语句共同联合完成。
...
1. 数据库事务是一组（可以包含一个或多个操作）数据库操作， 当这些操作构成一个逻辑上的整体。
...
![image-20200922195759124](Mysql事务/image-20200922195759124.png)

![image-20200922195808629](Mysql事务/image-20200922195808629.png)
...
![image-20200922192420580](Mysql事务/image-20200922192420580.png)

![image-20200922195707511](Mysql事务/image-20200922195707511.png)

![image-20200922195735861](Mysql事务/image-20200922195735861.png)
...
![image-20200922184326851](Mysql事务/image-20200922184326851.png)
