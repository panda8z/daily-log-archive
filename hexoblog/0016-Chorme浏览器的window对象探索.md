---
title: Chorme浏览器的window对象探索
date: 2018-10-25 09:59:53
tags:
---


```console
THREE: {WebGLRenderTargetCube: ƒ, WebGLRenderTarget: ƒ, WebGLRenderer: ƒ, ShaderLib: {…}, UniformsLib: {…}, …}
alert: ƒ alert()
animate: ƒ animate()
...
btoa: ƒ btoa()
caches: CacheStorage {}
camera: PerspectiveCamera {uuid: "99E23D37-F2BD-49E8-93D9-FA1997A261DB", name: "", type: "PerspectiveCamera", parent: null, children: Array(0), …}
...
cube: Mesh {uuid: "C0A322D8-1E3A-4B3D-B95E-57B92117F4F0", name: "", type: "Mesh", parent: Scene, children: Array(0), …}
...
geometry: BoxGeometry {uuid: "D3988FA5-57D3-4999-927A-A27A0C097F5E", name: "", type: "BoxGeometry", vertices: Array(8), colors: Array(0), …}
...
length: 0
localStorage: Storage {visited-pages: "[{"path":"/Users/zcj/Library/Android/sdk/docs/guid…de/topics/graphics/prop-animation.html","hit":1}]", length: 1}
location: Location {replace: ƒ, assign: ƒ, href: "file:///Users/zcj/Downloads/Three.js/HelloWorld.html", ancestorOrigins: DOMStringList, origin: "file://", …}
locationbar: BarProp {visible: true}
matchMedia: ƒ matchMedia()
material: MeshBasicMaterial {uuid: "3FC4E09F-74D8-4273-8B1C-F417EA1FF6CF", name: "", type: "MeshBasicMaterial", fog: true, lights: false, …}
...
performance: Performance {timeOrigin: 1540432691954.907, onresourcetimingbufferfull: null, memory: MemoryInfo, navigation: PerformanceNavigation, timing: PerformanceTiming}
personalbar: BarProp {visible: true}
postMessage: ƒ ()
print: ƒ print()
prompt: ƒ prompt()
releaseEvents: ƒ releaseEvents()
renderer: WebGLRenderer {domElement: canvas, context: WebGLRenderingContext, autoClear: true, autoClearColor: true, autoClearDepth: true, …}
requestAnimationFrame: ƒ requestAnimationFrame()
requestIdleCallback: ƒ requestIdleCallback()
resizeBy: ƒ resizeBy()
resizeTo: ƒ resizeTo()
scene: Scene {uuid: "47B619B7-2C4F-430A-9893-D81679FC8243", name: "", type: "Scene", parent: null, children: Array(1), …}
...
visualViewport: VisualViewport {offsetLeft: 0, offsetTop: 0, pageLeft: 0, pageTop: 0, width: 784, …}
...
WebGL2ComputeRenderingContext: ƒ WebGL2ComputeRenderingContext()
